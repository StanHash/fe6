...
.L08070EFE:
	...
	adds r1, r7, #0
	bl Decompress
	ldr r6, .L08070F5C @ =gUnk_0203D40C
	adds r0, r6, #0
	adds r1, r7, #0
	adds r2, r5, #0
...
.L08070FF0:
	...
	mov r3, sl
	adds r2, r3, r0
	ldr r3, .L080710F8 @ =gUnk_0203D40C
	lsls r0, r6, #2
	ldrh r3, [r3, #0x30]
	adds r0, r3, r0
	lsls r3, r5, #6
...
.L0807101A:
	...
	cmp r6, #0
	blt .L0807105C
	ldr r5, .L080710F8 @ =gUnk_0203D40C
.L08071022:
	adds r0, r6, #1
	lsls r1, r0, #5
	cmp r1, r7
...
.L0807105C:
	...
	cmp r5, #0
	blt .L0807109E
	ldr r6, .L080710F8 @ =gUnk_0203D40C
.L08071064:
	adds r0, r5, #1
	lsls r0, r0, #4
	cmp r0, r8
...
.L0807109E:
	...
	ldr r4, .L080710F8 @ =gUnk_0203D40C
	ldrh r0, [r4, #0x30]
	adds r0, #0x3e
	str r0, [sp]
	movs r0, #0
...
func_fe6_08071374: @ 0x08071374
	...
	adds r5, r0, #0
	ldr r4, [r5, #0x58]
	ldr r0, .L0807139C @ =gUnk_0203D40C
	bl SetTextFont
	movs r0, #0
...
func_fe6_080713DC: @ 0x080713DC
	...
	adds r5, r0, #0
	ldr r4, [r5, #0x58]
	ldr r0, .L0807140C @ =gUnk_0203D40C
	bl SetTextFont
	adds r0, r4, #0
	bl func_fe6_08070B30
	cmp r0, #1
...
func_fe6_08071410: @ 0x08071410
	...
	push {r4, r5, r6}
	mov sl, r0
	ldr r5, .L080714B0 @ =gUnk_0203D40C
	adds r0, r5, #0
	bl SetTextFont
	movs r0, #1
	bl SetTextFontGlyphs
...
func_fe6_08071514: @ 0x08071514
	push {r4, lr}
	ldr r4, .L08071550 @ =gUnk_0203D40C
	adds r0, r4, #0
	bl SetTextFont
	adds r0, r4, #0
	adds r0, #0x18
