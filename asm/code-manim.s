...
func_fe6_080668D8: @ 0x080668D8
	...
	ldr r1, .L080669B8 @ =ProcScr_Unk_086660FC
	adds r0, r1, #0
	ldr r1, [r7]
	bl SpawnProc
	ldr r0, [r7]
...
.L080669B8: .4byte ProcScr_Unk_086660FC
...
func_fe6_08066AD4: @ 0x08066AD4
	...
	mov r7, sp
	str r0, [r7]
	ldr r1, .L08066B34 @ =ProcScr_Unk_08665454
	adds r0, r1, #0
	movs r1, #3
	bl SpawnProc
	str r0, [r7, #4]
	...
	bx r0
	.align 2, 0
.L08066B34: .4byte ProcScr_Unk_08665454
...
func_fe6_08066DFC: @ 0x08066DFC
	...
	mov r7, sp
	str r0, [r7]
	ldr r1, .L08066E5C @ =ProcScr_Unk_08665494
	adds r0, r1, #0
	movs r1, #3
	bl SpawnProc
	str r0, [r7, #4]
	...
	bx r0
	.align 2, 0
.L08066E5C: .4byte ProcScr_Unk_08665494
...
func_fe6_08066FD8: @ 0x08066FD8
	...
	str r0, [r7]
	str r1, [r7, #4]
	ldr r1, .L08067038 @ =ProcScr_Unk_086654BC
	adds r0, r1, #0
	movs r1, #3
	bl SpawnProc
	str r0, [r7, #8]
	...
	bx r0
	.align 2, 0
.L08067038: .4byte ProcScr_Unk_086654BC
...
func_fe6_08067498: @ 0x08067498
	...
	str r2, [r7, #8]
	str r3, [r7, #0xc]
	ldr r0, .L08067510 @ =ProcScr_Unk_08665514
	ldr r1, [r7, #0xc]
	bl SpawnProc
	str r0, [r7, #0x10]
	ldr r0, [r7, #0x10]
	...
	bx r0
	.align 2, 0
.L08067510: .4byte ProcScr_Unk_08665514

	thumb_func_start func_fe6_08067514
func_fe6_08067514: @ 0x08067514
	push {r7, lr}
	mov r7, sp
	ldr r1, .L08067528 @ =ProcScr_Unk_08665514
	adds r0, r1, #0
	bl Proc_EndEach
	pop {r7}
	pop {r0}
	bx r0
	.align 2, 0
.L08067528: .4byte ProcScr_Unk_08665514
...
func_fe6_080675AC: @ 0x080675AC
	...
	str r0, [r7, #0xc]
.L08067636:
	ldr r0, .L0806766C @ =gManimLevelUpLabelInfoList
	ldr r1, [r7, #0xc]
	adds r3, r1, #0
	lsls r2, r3, #1
	adds r2, r2, r1
...
.L0806766C: .4byte gManimLevelUpLabelInfoList
.L08067670:
	ldr r0, .L080676E0 @ =gManimLevelUpLabelInfoList
	ldr r1, [r7, #0xc]
	adds r3, r1, #0
	lsls r2, r3, #1
	adds r2, r2, r1
	...
	adds r1, r1, r0
	lsls r0, r1, #5
	ldr r1, .L080676E0 @ =gManimLevelUpLabelInfoList
	ldr r2, [r7, #0xc]
	adds r5, r2, #0
	lsls r3, r5, #1
	adds r3, r3, r2
	...
	b .L080676EE
	.align 2, 0
.L080676E0: .4byte gManimLevelUpLabelInfoList
...
MALevelUp_DrawActorStat: @ 0x08067720
	...
	adds r1, #0x10
	strb r0, [r1]
	ldr r0, .L080677A0 @ =gManimLevelUpLabelInfoList
	ldr r1, [r7, #0xc]
	adds r3, r1, #0
	lsls r2, r3, #1
	adds r2, r2, r1
	...
	lsls r1, r0, #5
	adds r0, r1, #4
	ldr r1, .L080677A0 @ =gManimLevelUpLabelInfoList
	ldr r2, [r7, #0xc]
	adds r5, r2, #0
	lsls r3, r5, #1
	adds r3, r3, r2
...
.L0806778E:
	...
	bx r0
	.align 2, 0
.L080677A0: .4byte gManimLevelUpLabelInfoList
...
func_fe6_08067A28: @ 0x08067A28
	...
	str r2, [r7, #8]
	str r3, [r7, #0xc]
	ldr r0, .L08067ADC @ =ProcScr_Unk_0866559C
	ldr r1, [r7, #0xc]
	bl SpawnProc
	str r0, [r7, #0x10]
	ldr r0, [r7, #0x10]
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, .L08067AEC @ =ProcScr_Unk_086655AC
	ldr r1, [r7, #0x10]
	bl SpawnProc
	str r0, [r7, #0x14]
	ldr r1, [r7, #0x14]
...
func_fe6_08067AF0: @ 0x08067AF0
	...
	bx r0
	.align 2, 0
.L08067B04: .4byte ProcScr_Unk_0866559C
...
func_fe6_08067B08: @ 0x08067B08
	...
	str r0, [r7, #0x20]
	ldr r1, .L08067B8C @ =ProcScr_Unk_0866559C
	adds r0, r1, #0
	bl FindProc
	str r0, [r7, #0x1c]
	ldr r0, [r7, #0x1c]
...
.L08067B8C: .4byte ProcScr_Unk_0866559C
...
func_fe6_08067CF8: @ 0x08067CF8
	...
	str r0, [r7]
	str r1, [r7, #4]
	ldr r0, .L08067D28 @ =ProcScr_Unk_086655C4
	ldr r1, [r7, #4]
	bl SpawnProcLocking
	str r0, [r7, #8]
	ldr r0, [r7, #8]
	...
	bx r0
	.align 2, 0
.L08067D28: .4byte ProcScr_Unk_086655C4
...
.L08068252:
	...
	movs r0, #1
	bl EnableBgSync
	ldr r0, .L08068310 @ =gManimLevelUpLabelInfoList
	ldr r1, [r7, #4]
	adds r3, r1, #0
	lsls r2, r3, #1
	adds r2, r2, r1
...
.L08068308:
	...
	bx r0
	.align 2, 0
.L08068310: .4byte gManimLevelUpLabelInfoList
...
func_fe6_080684EC: @ 0x080684EC
	...
	cmp r0, #0
	beq .L0806850C
	ldr r1, .L08068508 @ =ProcScr_Unk_08665684
	adds r0, r1, #0
	ldr r1, [r7]
	bl SpawnProcLocking
	b .L08068516
	.align 2, 0
.L08068508: .4byte ProcScr_Unk_08665684
.L0806850C:
	ldr r1, .L08068520 @ =ProcScr_Unk_08665684
	adds r0, r1, #0
	movs r1, #3
	bl SpawnProc
.L08068516:
	...
	bx r0
	.align 2, 0
.L08068520: .4byte ProcScr_Unk_08665684
