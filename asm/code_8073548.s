...
func_fe6_08079C38: @ 0x08079C38
	...
	adds r5, r6, #0
	adds r5, #0x34
	ldr r1, .L08079D48 @ =gUnk_0200E864
	mov r8, r1
...
func_fe6_08079D84: @ 0x08079D84
	...
	sub sp, #8
	adds r4, r0, #0
	ldr r5, .L08079E90 @ =gUnk_0200E6D4
	adds r4, #0x30
	ldrb r1, [r4]
	lsls r0, r1, #2
	adds r0, r0, r5
...
.L08079DE2:
	lsls r1, r6, #3
	ldr r0, .L08079E98 @ =gUnk_0200E864
	adds r4, r1, r0
	adds r0, r4, #0
	bl ClearText
	lsls r1, r6, #1
...
.L08079E78:
	...
	bx r0
	.align 2, 0
.L08079E90: .4byte gUnk_0200E6D4
.L08079E94: .4byte gBg0Tm+0x200
.L08079E98: .4byte gUnk_0200E864
...
.L08079F8E:
	...
	bne .L08079FE0
	lsls r0, r6, #2
	ldr r1, .L08079FDC @ =gUnk_0200E6D4
	adds r0, r0, r1
	ldr r0, [r0]
...
.L08079FDC: .4byte gUnk_0200E6D4
.L08079FE0:
	lsls r0, r6, #2
	ldr r2, .L0807A000 @ =gUnk_0200E6D4
	adds r0, r0, r2
	ldr r1, [r0]
	movs r0, #8
	ldrh r1, [r1, #0xc]
...
.L0807A00E:
	...
	add r4, sb
	lsls r0, r6, #2
	ldr r1, .L0807A074 @ =gUnk_0200E6D4
	adds r0, r0, r1
	ldr r0, [r0]
	ldr r0, [r0]
	ldrh r0, [r0]
...
.L0807A110:
	...
	blt .L0807A0CC
.L0807A118:
	ldr r0, .L0807A170 @ =gUnk_0200F0A4
