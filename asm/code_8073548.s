...
func_fe6_080791A0: @ 0x080791A0
	ldr r1, .L080791B0 @ =gUnk_0203D494
	movs r2, #0
	adds r0, r1, #4
.L080791A6:
	strb r2, [r0]
...
func_fe6_080791B4: @ 0x080791B4
	...
	lsrs r3, r0, #0x18
	movs r2, #0
	ldr r4, .L080791CC @ =gUnk_0203D494
.L080791BE:
	adds r1, r2, r4
	ldrb r0, [r1]
	cmp r0, #0
...
func_fe6_080791DC: @ 0x080791DC
	...
	lsrs r2, r0, #0x18
	movs r1, #0
	ldr r3, .L0807920C @ =gUnk_0203D494
	adds r4, r3, #0
.L080791E8:
	adds r0, r1, r3
	ldrb r0, [r0]
