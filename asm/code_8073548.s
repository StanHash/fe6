...
func_fe6_08074BA4: @ 0x08074BA4
	...
	b .L08074D2C
.L08074BC2:
	ldr r2, .L08074D40 @ =gUnk_0200CD38
	mov r8, r2
...
.L08074CE2:
	...
	adds r0, r0, r1
	strb r5, [r0, #0xa]
	ldr r0, .L08074D50 @ =gUnk_0200CC38
	mov r2, r8
	ldrb r1, [r2]
	lsls r2, r1, #2
	adds r2, r2, r0
...
func_fe6_08074D54: @ 0x08074D54
	...
	movs r0, #1
	mov sb, r0
	ldr r1, .L08074EDC @ =gUnk_0200CD38
	mov r8, r1
...
.L08074E86:
	...
	adds r0, r0, r1
	strb r5, [r0, #0xa]
	ldr r0, .L08074EEC @ =gUnk_0200CC38
	mov r2, r8
	ldrb r1, [r2]
	lsls r2, r1, #2
	adds r2, r2, r0
...
func_fe6_08074EF0: @ 0x08074EF0
	...
	mov r0, r8
	bl StartGreenText
	ldr r1, .L08074FD0 @ =gUnk_0200CD38
	movs r0, #0
	strb r0, [r1]
	mov r1, r8
	adds r1, #0x3b
...
.L08075068:
	...
	movs r1, #0x14
	bl InitText
	ldr r0, .L08075118 @ =gUnk_0200D6AC
	movs r1, #4
	bl InitText
	mov r6, sl
	ldrb r0, [r6]
...
.L0807512C:
	...
	bl PutText
	movs r5, #0
	ldr r2, .L08075190 @ =gUnk_0200E6B4
	movs r1, #0xff
.L08075166:
	lsls r0, r5, #2
	adds r0, r0, r2
...
.L080751B0:
	...
	cmp r5, r0
	bge .L080751BE
	ldr r0, .L080752F0 @ =gUnk_0200CD38
	ldrb r0, [r0]
	cmp r5, r0
	blo .L08075194
.L080751BE:
...
func_fe6_080753A0: @ 0x080753A0
	...
	ldrb r7, [r0]
	adds r4, r7, #0
	ldr r1, .L0807542C @ =gUnk_0200CC38
	lsls r0, r7, #2
	adds r6, r0, r1
	ldr r0, [r6]
	ldr r1, [r0]
