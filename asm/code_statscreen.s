...
func_fe6_0806EB48: @ 0x0806EB48
	...
	push {r7}
	sub sp, #8
	ldr r7, .L0806EC48 @ =gStatScreenSt
	ldr r0, [r7, #0xc]
	ldr r0, [r0]
	ldrh r0, [r0]
	bl DecodeMsg
...
func_fe6_0806ED34: @ 0x0806ED34
	...
	ldr r4, .L0806ED90 @ =gStatScreenSt
	ldr r0, [r4, #0xc]
	bl UnitKnowsMagic
	lsls r0, r0, #0x18
	asrs r2, r0, #0x18
...
.L0806ED9C:
	...
	bl PutDrawText
.L0806EDB0:
	ldr r6, .L0806EFD8 @ =gStatScreenSt
	ldr r0, [r6, #0xc]
	bl GetUnitPower
	ldr r1, [r6, #0xc]
	movs r3, #0x12
...
func_fe6_0806EFE0: @ 0x0806EFE0
	...
	bl func_fe6_0806EB00
	movs r4, #0
	ldr r1, .L0806F14C @ =gStatScreenSt
	ldr r0, [r1, #0xc]
	ldrh r5, [r0, #0x1c]
	cmp r5, #0
	beq .L0806F064
...
.L0806F02C:
	...
	bne .L0806F02C
.L0806F064:
	ldr r7, .L0806F14C @ =gStatScreenSt
	ldr r0, [r7, #0xc]
	bl GetUnitEquippedWeaponSlot
	adds r4, r0, #0
	movs r5, #0
