...
sub_80350C8: @ 0x080350C8
	push {r4, r5, lr}
	ldr r4, .L080350DC @ =0x03004568
	ldr r3, [r4]
	cmp r3, #0
	beq .L080350E4
	cmp r3, #1
	beq .L08035150
	ldr r0, .L080350E0 @ =0x030013BC
	ldr r0, [r0]
	b .L080351DA
	.align 2, 0
.L080350DC: .4byte 0x03004568
.L080350E0: .4byte 0x030013BC
.L080350E4:
...
.L08035144: .4byte 0x030013B8
.L08035148: .4byte 0x030013BC
.L0803514C: .4byte 0x030044D4
.L08035150:
	ldr r0, .L08035184 @ =0x04000128
	ldrh r0, [r0]
	adds r2, r0, #0
	ldr r0, .L08035188 @ =0x030044D4
	ldr r0, [r0]
...
.L08035198:
	...
	mvns r0, r0
	strh r0, [r2, #2]
	ldr r0, .L080351C0 @ =0x030013BC
	ldr r0, [r0]
	cmp r0, #0
	beq .L080351C8
	ldr r1, .L080351C4 @ =0x030013B8
	movs r3, #0xc0
	lsls r3, r3, #7
	adds r0, r3, #0
	b .L080351D0
...
.L080351C0: .4byte 0x030013BC
.L080351C4: .4byte 0x030013B8
.L080351C8:
	ldr r1, .L080351E0 @ =0x030013B8
	movs r5, #0xc1
	lsls r5, r5, #7
	adds r0, r5, #0
.L080351D0:
...
sub_803522C: @ 0x0803522C
	...
	ldr r0, [r2]
	strh r3, [r0, #0x30]
	ldr r0, .L08035388 @ =0x030013C8
	mov sb, r0
	ldr r1, .L0803538C @ =0x030013CA
	mov r8, r1
	adds r5, r2, #0
	movs r4, #0
.L08035280:
...
.L08035330:
	...
	bne .L08035330
	movs r4, #0
	ldr r2, .L0803539C @ =0x030013D0
	mov r8, r2
	movs r5, #0
	ldr r0, .L080353A0 @ =0x000001FF
	mov ip, r0
	ldr r7, .L080353A4 @ =0x0203B618
	ldr r6, .L080353A8 @ =0x030013D8
.L0803534A:
	lsls r0, r4, #1
	mov r1, r8
	adds r2, r0, r1
...
sub_8035414: @ 0x08035414
	...
	strh r3, [r0]
	ldr r2, .L08035474 @ =0x030044D4
	ldr r1, .L08035478 @ =0x030044D0
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L0803547C @ =0x03004568
	str r0, [r1]
	ldr r1, .L08035480 @ =0x030013BC
	subs r0, #1
	str r0, [r1]
	ldr r1, .L08035484 @ =sub_80354F0
	movs r0, #7
	bl SetIrqFunc
	ldr r1, .L08035488 @ =sub_8035880
	movs r0, #6
	bl SetIrqFunc
...
.L0803546C: .4byte 0x030013B8
.L08035470: .4byte 0x0400010E
.L08035474: .4byte 0x030044D4
.L08035478: .4byte 0x030044D0
.L0803547C: .4byte 0x03004568
.L08035480: .4byte 0x030013BC
.L08035484: .4byte sub_80354F0
.L08035488: .4byte sub_8035880
...
sub_8035490: @ 0x08035490
	...
	movs r0, #0
	strh r0, [r1]
	ldr r2, .L080354D8 @ =0x030044D4
	ldr r1, .L080354DC @ =0x030044D0
	movs r0, #0
	str r0, [r1]
	str r0, [r2]
	ldr r1, .L080354E0 @ =0x03004568
	str r0, [r1]
	ldr r1, .L080354E4 @ =0x030013BC
	subs r0, #1
	str r0, [r1]
	movs r0, #7
	movs r1, #0
...
.L080354D8: .4byte 0x030044D4
.L080354DC: .4byte 0x030044D0
.L080354E0: .4byte 0x03004568
.L080354E4: .4byte 0x030013BC
...
.L08035644: .4byte 0x030013D8
.L08035648: .4byte 0x0000FFFF
.L0803564C: .4byte 0x000001FF
.L08035650:
	ldr r0, .L0803569C @ =0x030013CA
	ldr r2, .L080356A0 @ =0x030013C8
	ldrh r3, [r2]
	ldrh r0, [r0]
	cmp r0, r3
	beq .L08035676
...
.L08035676:
	...
	b .L08035708
	.align 2, 0
.L0803569C: .4byte 0x030013CA
.L080356A0: .4byte 0x030013C8
...
.L080359A4: .4byte 0x0300456C
.L080359A8:
	adds r0, r5, #0
	bl sub_8036130
	ldr r0, .L080359D0 @ =0x0300456C
	movs r1, #0x1e
	strb r1, [r0]
	ldr r2, [r6]
	ldrb r4, [r2, #6]
...
sub_8035EC0: @ 0x08035EC0
	...
	movs r2, #0
	str r2, [sp, #0xc]
	ldr r1, .L08035F38 @ =0x030013D0
	lsrs r3, r0, #0x18
	str r3, [sp]
	asrs r2, r0, #0x17
	adds r3, r2, r1
	ldr r0, .L08035F3C @ =0x030013D8
	adds r7, r2, r0
	ldrh r5, [r7]
	mov sl, r1
	ldrh r0, [r3]
...
.L08035F30:
	...
	b .L08035F7A
	.align 2, 0
.L08035F38: .4byte 0x030013D0
.L08035F3C: .4byte 0x030013D8
...
.L080360C0: .4byte 0x030013B8

	thumb_func_start sub_80360C4
sub_80360C4: @ 0x080360C4
	push {r4, r5, r6, r7, lr}
	adds r2, r1, #0
	ldr r1, .L080360EC @ =0x030013D0
	ldr r0, .L080360F0 @ =0x030013D8
	ldrh r3, [r1]
	ldrh r0, [r0]
	cmp r3, r0
	bne .L080360F8
	...
	b .L08036122
	.align 2, 0
.L080360EC: .4byte 0x030013D0
.L080360F0: .4byte 0x030013D8
...
sub_8036440: @ 0x08036440
	...
	movs r1, #1
	bl sub_8036078
	ldr r1, .L08036484 @ =0x030013CA
	ldr r0, .L08036488 @ =0x030013C8
	ldrh r0, [r0]
	strh r0, [r1]
	ldr r3, .L0803648C @ =0x030013D0
	ldr r2, .L08036490 @ =0x030013D8
	movs r1, #3
.L08036468:
	ldrh r0, [r3]
	strh r0, [r2]
...
.L08036484: .4byte 0x030013CA
.L08036488: .4byte 0x030013C8
.L0803648C: .4byte 0x030013D0
.L08036490: .4byte 0x030013D8
...
sub_80364A4: @ 0x080364A4
	...
	movs r1, #1
	bl sub_8036078
	ldr r1, .L08036504 @ =0x030013CA
	ldr r0, .L08036508 @ =0x030013C8
	ldrh r0, [r0]
	strh r0, [r1]
	ldr r3, .L0803650C @ =0x030013D0
	ldr r2, .L08036510 @ =0x030013D8
	movs r1, #3
.L080364D4:
	ldrh r0, [r3]
	strh r0, [r2]
...
.L08036504: .4byte 0x030013CA
.L08036508: .4byte 0x030013C8
.L0803650C: .4byte 0x030013D0
.L08036510: .4byte 0x030013D8
...
sub_8036518: @ 0x08036518
	...
	movs r1, #0x88
	strh r1, [r0]
	ldr r1, .L08036580 @ =0x030013CA
	ldr r0, .L08036584 @ =0x030013C8
	ldrh r0, [r0]
	strh r0, [r1]
	adds r4, r3, #0
	ldr r3, .L08036588 @ =0x030013D0
	ldr r2, .L0803658C @ =0x030013D8
	movs r1, #3
.L08036548:
	ldrh r0, [r3]
	strh r0, [r2]
...
.L08036580: .4byte 0x030013CA
.L08036584: .4byte 0x030013C8
.L08036588: .4byte 0x030013D0
.L0803658C: .4byte 0x030013D8
...
sub_8036590: @ 0x08036590
	...
	movs r1, #0x18
	strh r1, [r0]
	ldr r1, .L080365F8 @ =0x030013CA
	ldr r0, .L080365FC @ =0x030013C8
	ldrh r0, [r0]
	strh r0, [r1]
	adds r4, r3, #0
	ldr r3, .L08036600 @ =0x030013D0
	ldr r2, .L08036604 @ =0x030013D8
	movs r1, #3
.L080365C0:
	ldrh r0, [r3]
	strh r0, [r2]
...
.L080365F8: .4byte 0x030013CA
.L080365FC: .4byte 0x030013C8
.L08036600: .4byte 0x030013D0
.L08036604: .4byte 0x030013D8

	thumb_func_start sub_8036608
sub_8036608: @ 0x08036608
	ldr r0, .L08036614 @ =0x030013CA
	ldr r1, .L08036618 @ =0x030013C8
	ldrh r1, [r1]
	strh r1, [r0]
	bx lr
	.align 2, 0
.L08036614: .4byte 0x030013CA
.L08036618: .4byte 0x030013C8
...
.L08036D8C: .4byte 0x030013E4
.L08036D90:
	ldr r0, .L08036DC4 @ =0x0203C940
	movs r6, #0
	str r6, [r0]
	ldr r1, .L08036DC8 @ =0x0203C920
	ldr r2, .L08036DCC @ =0x030013E0
	ldr r0, [r2]
	lsls r0, r0, #1
	adds r0, r0, r1
	strh r4, [r0]
	ldr r1, .L08036DD0 @ =0x030013E4
	ldr r4, [r1]
	lsls r0, r4, #1
	adds r0, r0, r5
	ldrh r0, [r0]
...
.L08036DCC: .4byte 0x030013E0
.L08036DD0: .4byte 0x030013E4
...
sub_803888C: @ 0x0803888C
	...
	movs r1, #0
	strb r1, [r0]
	ldr r0, .L080388A0 @ =sub_803882C
	bl SetOnHBlankA
	pop {r0}
	bx r0
	.align 2, 0
.L080388A0: .4byte sub_803882C
...
.L0803B2EE:
	...
	bge .L0803B2EE
	movs r1, #0
	ldr r3, .L0803B310 @ =0x030013E0
	ldr r2, .L0803B314 @ =0x030013E4
...
.L0803B310: .4byte 0x030013E0
.L0803B314: .4byte 0x030013E4
...
.L0803BE58: .4byte sub_803BD20
.L0803BE5C:
	ldr r0, .L0803BE70 @ =gUnk_Sio_02000000
	ldr r1, .L0803BE74 @ =sub_803BD90
	adds r2, r6, #0
	bl sub_8036884
.L0803BE66:
	add sp, #4
...
.L0803CA98:
	...
	bx lr
	.align 2, 0
.L0803CAA8: .4byte 0x03001418

	thumb_func_start sub_803CAAC
sub_803CAAC: @ 0x0803CAAC
	ldr r3, .L0803CAC4 @ =0x03001418
	adds r1, r0, #0
	adds r1, #0x1c
	movs r2, #4
.L0803CAB4:
...
.L0803CCB4: .4byte 0x030013F0
.L0803CCB8: .4byte 0x03001410

	thumb_func_start sub_803CCBC
sub_803CCBC: @ 0x0803CCBC
	ldr r1, .L0803CCD0 @ =0x030013F0
	movs r2, #0
	adds r0, r1, #0
	adds r0, #0x13
.L0803CCC4:
...
.L0803D01C:
	...
	bge .L0803D01C
	movs r4, #0
	ldr r0, .L0803D090 @ =0x030013F0
	ldrb r0, [r0, #3]
	bl GetUnit
	ldr r2, .L0803D094 @ =0x03001404
	movs r1, #0xe
	ldrsb r1, [r0, r1]
	lsls r1, r1, #4
	strh r1, [r2]
...
.L0803D090: .4byte 0x030013F0
.L0803D094: .4byte 0x03001404
...
sub_803D0A0: @ 0x0803D0A0
	...
	bx r0
	.align 2, 0
.L0803D0E0: .4byte 0x030013F0
.L0803D0E4: .4byte 0x0203C984
.L0803D0E8: .4byte 0x03001410
...
.L0803D1BC:
	...
	strb r2, [r0, #0xf]
	ldr r2, .L0803D1C8 @ =0x030013F0
	b .L0803D1CE
	.align 2, 0
.L0803D1C4: .4byte gPlaySt
.L0803D1C8: .4byte 0x030013F0
.L0803D1CC:
	adds r1, #1
.L0803D1CE:
	adds r0, r1, r2
...
.L0803D658:
	...
	bl GetGameTime
	subs r0, #1
	ldr r6, .L0803D6D0 @ =0x03001408
	ldr r1, [r6]
	cmp r0, r1
	bne .L0803D68E
	ldr r0, .L0803D6D4 @ =0x03001404
	movs r2, #0
	ldrsh r1, [r0, r2]
	adds r1, r5, r1
	asrs r5, r1, #1
...
.L0803D6D0: .4byte 0x03001408
.L0803D6D4: .4byte 0x03001404
...
sub_803D6EC: @ 0x0803D6EC
	...
	bl GetGameTime
	subs r0, #1
	ldr r7, .L0803D7D8 @ =0x03001408
	ldr r1, [r7]
	cmp r0, r1
	bne .L0803D758
	ldr r0, .L0803D7DC @ =0x03001404
	movs r2, #0
	ldrsh r1, [r0, r2]
	adds r1, r5, r1
	asrs r5, r1, #1
...
.L0803D7D0: .4byte 0x030013F0
.L0803D7D4: .4byte gActiveUnit
.L0803D7D8: .4byte 0x03001408
.L0803D7DC: .4byte 0x03001404
...
sub_803DB6C: @ 0x0803DB6C
	...
	cmp r0, #0
	bne .L0803DBAC
	ldr r0, .L0803DBA8 @ =0x03001410
	ldr r0, [r0, #4]
	bl EndMu
	b .L0803DBB4
	.align 2, 0
.L0803DBA0: .4byte 0x030013F0
.L0803DBA4: .4byte 0x0203C984
.L0803DBA8: .4byte 0x03001410
.L0803DBAC:
	ldr r0, [r5, #0x34]
	strb r0, [r4, #0xe]
	ldr r0, [r5, #0x38]
...
sub_803DC3C: @ 0x0803DC3C
	...
	bx r0
	.align 2, 0
.L0803DCB4: .4byte 0x030013F0
.L0803DCB8: .4byte 0x0203C984
.L0803DCBC: .4byte 0x03001410

	thumb_func_start sub_803DCC0
sub_803DCC0: @ 0x0803DCC0
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	ldr r4, .L0803DD18 @ =0x030013F0
...
.L0803DD9E:
	...
	bx r0
	.align 2, 0
.L0803DDA8: .4byte 0x030013F0
.L0803DDAC: .4byte 0x0203C984
.L0803DDB0: .4byte gAction
.L0803DDB4: .4byte 0x0300140C
...
.L0803DF3C:
	...
	b .L0803DF90
	.align 2, 0
.L0803DF4C: .4byte 0x030013F0
.L0803DF50: .4byte 0x0203C984
.L0803DF54: .4byte 0x03001410
.L0803DF58:
	adds r0, r4, #0
	bl StartMu
	str r0, [r6]
...
sub_803E204: @ 0x0803E204
	...
	sub sp, #8
	adds r5, r0, #0
	ldr r4, .L0803E22C @ =0x0300140C
	ldr r2, .L0803E230 @ =sub_803E1E8
	adds r0, r4, #0
	add r1, sp, #4
	bl sub_80362B0
	lsls r0, r0, #0x10
	...
	b .L0803E2AC
	.align 2, 0
.L0803E22C: .4byte 0x0300140C
.L0803E230: .4byte sub_803E1E8
.L0803E234:
	cmp r0, #7
	beq .L0803E294
	b .L0803E2AC
...
sub_803E2D0: @ 0x0803E2D0
	...
	sub sp, #8
	adds r5, r0, #0
	ldr r4, .L0803E2F4 @ =0x0300140C
	ldr r2, .L0803E2F8 @ =sub_803E2BC
	adds r0, r4, #0
	add r1, sp, #4
	bl sub_80362B0
	lsls r0, r0, #0x10
	...
	b .L0803E360
	.align 2, 0
.L0803E2F4: .4byte 0x0300140C
.L0803E2F8: .4byte sub_803E2BC
.L0803E2FC:
	ldrb r0, [r4, #2]
	bl GetUnit
	adds r4, r0, #0
	...
	cmp r0, #0
	bne .L0803E320
	ldr r0, .L0803E31C @ =0x03001410
	ldr r0, [r0]
	bl EndMu
	b .L0803E328
	.align 2, 0
.L0803E31C: .4byte 0x03001410
.L0803E320:
	ldr r0, [r5, #0x2c]
	strb r0, [r4, #0xe]
	ldr r0, [r5, #0x30]
...
sub_803E3C8: @ 0x0803E3C8
	...
	sub sp, #4
	adds r7, r0, #0
	ldr r4, .L0803E3EC @ =0x0300140C
	ldr r2, .L0803E3F0 @ =sub_803E3B4
	adds r0, r4, #0
	mov r1, sp
	bl sub_80362B0
	lsls r0, r0, #0x10
	...
	b .L0803E496
	.align 2, 0
.L0803E3EC: .4byte 0x0300140C
.L0803E3F0: .4byte sub_803E3B4
.L0803E3F4:
	ldrb r0, [r4, #2]
	bl GetUnit
	adds r6, r0, #0
	...
	cmp r0, #0
	bne .L0803E418
	ldr r0, .L0803E414 @ =0x03001410
	ldr r0, [r0, #4]
	bl EndMu
	b .L0803E420
	.align 2, 0
.L0803E414: .4byte 0x03001410
.L0803E418:
	ldr r0, [r7, #0x34]
	strb r0, [r6, #0xe]
	ldr r0, [r7, #0x38]
...
.L0803E87C: .4byte 0x0300140C

	thumb_func_start sub_803E880
sub_803E880: @ 0x0803E880
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, .L0803E8AC @ =0x0300140C
	ldrb r0, [r0, #1]
	bl GetUnit
	adds r1, r0, #0
	movs r0, #0xe
...
.L0803E92A:
	...
	bx r0
	.align 2, 0
.L0803E938: .4byte 0x0300140C
.L0803E93C: .4byte 0x0203C989
.L0803E940: .4byte 0x030013F0
...
sub_803FAA4: @ 0x0803FAA4
	...
	ldr r0, .L0803FAFC @ =gUnk_086773D8
	bl Proc_EndEach
	movs r2, #0
	movs r0, #0x14
	subs r0, r0, r5
...
.L0803FAD0:
	movs r2, #0
	lsls r1, r5, #5
	ldr r5, .L0803FAFC @ =gUnk_086773D8
	cmp r2, r1
	bge .L0803FAEA
...
sub_803FB08: @ 0x0803FB08
	...
	ldr r0, .L0803FB6C @ =gUnk_086773D8
	bl Proc_EndEach
	movs r2, #0
	movs r6, #0xf
...
.L0803FB6C: .4byte gUnk_086773D8
.L0803FB70: .4byte 0x0000027F

	thumb_func_start sub_803FB74
sub_803FB74: @ 0x0803FB74
	push {lr}
	ldr r0, .L0803FB80 @ =gUnk_086773D8
	bl Proc_EndEach
	pop {r0}
	bx r0
	.align 2, 0
.L0803FB80: .4byte gUnk_086773D8
