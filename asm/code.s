...
.L08089B66:
	...
	ldr r3, .L08089BB0 @ =gUnk_Savemenu_02000404
	ldrh r1, [r7, #0x2a]
	lsrs r0, r1, #2
	movs r1, #0xf
	ands r0, r1
...
.L08089BB0: .4byte gUnk_Savemenu_02000404
.L08089BB4:
...
.L08089FCE:
	...
	lsls r2, r0, #5
	adds r2, #0x1e
	ldr r3, .L08089FF8 @ =Sprite_0868A158
	movs r0, #0
	b .L0808A00A
	.align 2, 0
...
.L08089FF8: .4byte Sprite_0868A158
.L08089FFC:
	adds r0, #0x3f
	ldrb r0, [r0]
	lsls r2, r0, #5
	adds r2, #0x1e
	ldr r3, .L0808A018 @ =Sprite_0868A158
	movs r0, #0xc0
	lsls r0, r0, #7
.L0808A00A:
	str r0, [sp]
	...
	b .L0808A07C
	.align 2, 0
.L0808A018: .4byte Sprite_0868A158
.L0808A01C:
	adds r0, r2, #0
	adds r0, #0x2e
	ldrb r0, [r0]
...
.L0808A042:
	...
	lsls r2, r0, #5
	adds r2, #0x1e
	ldr r3, .L0808A0EC @ =Sprite_0868A158
	movs r0, #0xc0
	lsls r0, r0, #7
	str r0, [sp]
	movs r0, #4
...
.L0808A07C:
	...
	b .L0808A112
	.align 2, 0
.L0808A0EC: .4byte Sprite_0868A158
...
.L0808A2DC:
	...
	ldrb r2, [r0]
	add r2, r8
	ldr r0, .L0808A33C @ =Sprite_0868A150
	mov sl, r0
	movs r4, #0x80
	lsls r4, r4, #5
	str r4, [sp]
	...
	b .L0808A360
	.align 2, 0
.L0808A33C: .4byte Sprite_0868A150
.L0808A340:
	ldrh r1, [r7, #0x2a]
	lsrs r0, r1, #3
	movs r1, #7
	...
	ldrb r2, [r0]
	add r2, r8
	ldr r3, .L0808A36C @ =Sprite_0868A150
	movs r0, #0x80
	lsls r0, r0, #6
	str r0, [sp]
	movs r0, #4
...
.L0808A360:
	...
	b .L0808A37C
	.align 2, 0
.L0808A36C: .4byte Sprite_0868A150
.L0808A370:
	ldrb r2, [r2]
	cmp r2, #4
	bne .L0808A37C
...
.L0808A37C:
	...
	adds r0, #0x32
	ldrb r2, [r0]
	ldr r3, .L0808A3C4 @ =Sprite_0868A150
	movs r0, #0x80
	lsls r0, r0, #6
	str r0, [sp]
	movs r0, #4
...
.L0808A3AA:
	...
	bx r0
	.align 2, 0
.L0808A3C4: .4byte Sprite_0868A150
