...
.L0806C812:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, .L0806C864 @ =Sprite_0866ACCC
...
.L0806C864: .4byte Sprite_0866ACCC
...
.L0806C86C:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, .L0806C898 @ =Sprite_0866ACCC
	ldr r3, .L0806C89C @ =0x00002822
	bl PutOamHiRam
	b .L0806C8C6
	.align 2, 0
.L0806C894: .4byte gBmSt
.L0806C898: .4byte Sprite_0866ACCC
...
.L0806C8A0:
	...
	movs r2, #0xff
	ands r1, r2
	ldr r2, .L0806C910 @ =Sprite_0866ACCC
...
.L0806C910: .4byte Sprite_0866ACCC
...
func_fe6_0806C950: @ 0x0806C950
	...
	beq .L0806C98A
.L0806C97E:
	ldr r0, .L0806C994 @ =ProcScr_Unk_0866ACE8
	bl Proc_EndEach
	adds r0, r4, #0
	bl Proc_Break
.L0806C98A:
...
.L0806C994: .4byte ProcScr_Unk_0866ACE8
...
func_fe6_0806C998: @ 0x0806C998
	...
	cmp r0, #0
	beq .L0806C9E0
	ldr r0, .L0806C9F4 @ =ProcScr_Unk_0866ACE8
	movs r1, #3
	bl SpawnProc
	movs r0, #0
	bl GetTarget
...
.L0806C9F4: .4byte ProcScr_Unk_0866ACE8
...
func_fe6_0806C9F8: @ 0x0806C9F8
	...
	cmp r4, #0
	bne .L0806CA0E
	ldr r0, .L0806CA18 @ =ProcScr_Unk_0866AD00
	movs r1, #3
	bl SpawnProc
.L0806CA0E:
	adds r0, r4, #0
	...
	bx r1
	.align 2, 0
.L0806CA18: .4byte ProcScr_Unk_0866AD00
...
func_fe6_0806CC68: @ 0x0806CC68
	ldr r0, .L0806CC78 @ =gUnk_0203D354
	ldr r0, [r0]
	movs r1, #2
	ands r0, r1
	cmp r0, #0
...
.L0806CDF0:
	...
	bne .L0806CE06
.L0806CDFA:
	ldr r0, .L0806CE0C @ =gUnk_0203D358
	ldr r0, [r0]
	movs r1, #2
	ands r0, r1
	cmp r0, #0
...
func_fe6_0806CE18: @ 0x0806CE18
	ldr r0, .L0806CE2C @ =gUnk_0203D358
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #8
	ands r0, r1
...
func_fe6_0806CE34: @ 0x0806CE34
	ldr r0, .L0806CE48 @ =gUnk_0203D358
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #9
	ands r0, r1
...
func_fe6_0806CE50: @ 0x0806CE50
	...
	cmp r0, #0
	bne .L0806CE78
	ldr r0, .L0806CE70 @ =gUnk_0203D358
	ldr r0, [r0]
...
func_fe6_0806CE80: @ 0x0806CE80
	...
	cmp r0, #0
	bne .L0806CE9C
	ldr r0, .L0806CEA0 @ =gUnk_0203D358
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #1
	ands r0, r1
...
func_fe6_0806CEAC: @ 0x0806CEAC
	...
	cmp r0, #0
	bne .L0806CEC8
	ldr r0, .L0806CECC @ =gUnk_0203D358
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #0x10
	ands r0, r1
